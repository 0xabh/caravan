...
const accountSlice = createSlice({
    ...
    reducers: {
        ...
        setExistingAccountData: (state, {payload}) => {
            state.accountsData = payload.accountsData
            state.combinedData = payload.combinedData
            state.accountAdded = payload.accountAdded
        }
    },
});

export const {addNewAccount, resetAccountAdded, setAccountData, setExistingAccountData} =
